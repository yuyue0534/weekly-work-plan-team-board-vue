  ...
  <tr :data-task-index="index">
    <td class="task-name-col">
      <input
        ...
        :value="task.taskName"
        @input="updateField('taskName', $event.target.value)"
      />
    </td>
    ...
    <td class="remark-col">
      <textarea
        ...
        :value="task.remarkBlocker"
        @input="updateField('remarkBlocker', $event.target.value)"
      ></textarea>
    </td>
...
function updateField(field, value) {
  emit("update-field", props.index, field, value);
}

function updateSlot(slotKey, checked) {
  emit("update-slot", props.index, slotKey, checked);
}
</script>
